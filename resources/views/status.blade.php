...
<head>
    ...
    <title>Enterprise Dynamic Systems</title>
...
<body style="background-image: url(image/body3.png)" class="bg-auto bg-no-repeat bg-fixed">
    ...
    <!--Container-->
    <div class="mx-auto bg-blue-400 p-4 m-4 text-white w-98 text-center font-semibold">Berisi informasi terkait status
        perusahaan berdasarkan kategori perusahaan domestik maupun perusahaan asing yang sudah terdaftar dari sistem PSE
        lingkup Privat. Sumber data yang digunakan berasal dari Kementrian Komunikasi dan Informatika. Masyarakat maupun
        Pemilik Perusahaan dapat melihat status perusahaan tersebut melalui dashboard yang telah dibentuk.</div>
    <div class='tableauPlaceholder mx-auto' id='viz1698569355317' style='position: relative'><noscript><a
                href='#'><img alt='Dashboard 2 '
                    src='https:&#47;&#47;public.tableau.com&#47;static&#47;images&#47;ED&#47;EDSStatus&#47;Dashboard2&#47;1_rss.png'
                    style='border: none' /></a></noscript><object class='tableauViz' style='display:none;'>
            <param name='host_url' value='https%3A%2F%2Fpublic.tableau.com%2F' />
            <param name='embed_code_version' value='3' />
            <param name='site_root' value='' />
            <param name='name' value='EDSStatus&#47;Dashboard2' />
            <param name='tabs' value='no' />
            <param name='toolbar' value='yes' />
            <param name='static_image'
                value='https:&#47;&#47;public.tableau.com&#47;static&#47;images&#47;ED&#47;EDSStatus&#47;Dashboard2&#47;1.png' />
    ...
    <script type='text/javascript'>
        var divElement = document.getElementById('viz1698569355317');
