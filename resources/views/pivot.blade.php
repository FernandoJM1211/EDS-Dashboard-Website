...
<body style="background-image: url(image/body3.png)" class="bg-auto bg-no-repeat bg-fixed">
    ...
    <!-- container -->
    <div class="mx-auto bg-blue-400 p-4 m-4 text-white w-98 text-center font-semibold">Dashboard berikut memberikan
        keleluasaan bagi user untuk membuat analisa sesuai dengan keinginan user. Sumber data yang digunakan berasal
        dari Kementrian Komunikasi dan Informatika.</div>
    <div class='tableauPlaceholder mx-auto' id='viz1698572831453' style='position: relative'><noscript><a
                href='#'><img alt='Dashboard 4 '
                    src='https:&#47;&#47;public.tableau.com&#47;static&#47;images&#47;ED&#47;EDSCrosstabAnalysis&#47;Dashboard4&#47;1_rss.png'
                    style='border: none' /></a></noscript><object class='tableauViz' style='display:none;'>
            <param name='host_url' value='https%3A%2F%2Fpublic.tableau.com%2F' />
            <param name='embed_code_version' value='3' />
            <param name='site_root' value='' />
            <param name='name' value='EDSCrosstabAnalysis&#47;Dashboard4' />
            <param name='tabs' value='no' />
            <param name='toolbar' value='yes' />
            <param name='static_image'
                value='https:&#47;&#47;public.tableau.com&#47;static&#47;images&#47;ED&#47;EDSCrosstabAnalysis&#47;Dashboard4&#47;1.png' />
    ...
    <script type='text/javascript'>
        var divElement = document.getElementById('viz1698572831453');
